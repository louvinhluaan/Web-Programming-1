        ...
        <div class="card-body">
            ...
            <?php if (in_array('admin', $_SESSION['roles']) || $_SESSION['userid'] == $question['userid']): ?>
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <!-- Button Edit -->
                    <a href="edit_question.php?id=<?= $question['id'] ?>" class="btn btn-primary me-md-1">Edit</a>
                    <!-- Button Delete -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete_question">
                        Delete
                    </button>
                    <!-- Modal For Delete Question -->
                    <div class="modal fade" id="delete_question" tabindex="-1" aria-labelledby="deleteQuestionLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="delete_question.php?id=<?= $question['id'] ?>" class="btn btn-danger">Delete</a>
                        </div>
                        </div>
                    </div>
                    </div>                
